% [true1, true2, true3] = TRUEV2D(x)
%
% Returns the values of the solution function, plus
% its first two derivatives on x.
...
case {12}
    Uname ='x.*x - x';
true1 = x.*x - x;   true2 = 2*x - 1;     true3 = 2;

case {11}
    Uname ='x.*x';
true1 = x.*x;       true2 = 2*x;         true3 = 2;

case {1}
    Uname ='x';
true1 = x;         true2 = 1;           true3 = 0;

case {0}
    Uname ='1';
true1 = 1;         true2 = 0;           true3 = 0;
