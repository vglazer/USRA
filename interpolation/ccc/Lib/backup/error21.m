...
%
% compute the max. error of the 1D spline approx. and derivatives 
% (u, ux, uxx) at the grid points, midpoints, the "arbitrary" constant 
...
if nargin < 16, truef = 'truev2d';, end
