% [errg, errm, errt, errs] = ERROR41(ngrid, gridx, n, amidx, ...
%     nconst, tx, gaussx, dof, nn, errg, ...
%     errm, errt, errs, evalfunc, extx, nderv, truef)
%
...
function [errg, errm, errt, errs] = ...
    error41(ngrid, gridx, n, amidx, nconst, tx, gaussx, ...
...
if nargin < 17, truef = 'truev4d';, end
