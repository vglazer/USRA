...
%
% returns the values of the non-zero order k (i.e. degree k-1) 
% b-splines and the first nderiv-1 derivatives at x.
% xt is the (extended) gridpoint sequence.
% vnikx is k X nderiv.
% ileft is the index of the xt gridpoint to the left of x, starting 
% with 1.
% If x is a gridpoint, ileft is its index.
% bspl(i, j) is the value of the j-1st deriv. of the i-th non-zero 
% spline
