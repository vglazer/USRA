...
for a number of other programs, including asub\_search, wsub\_search, reg\_search
and ereg\_search.
...
list format, allowing wsub\_search to be used for unweighted graphs also. A few
additional changes to sub\_search were required, most concerning the 
