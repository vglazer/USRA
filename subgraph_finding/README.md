...
```
One benefit of the 1-step approach is that you avoid having to store the graph, which may in general be large, until you actually find some interesting subgraphs. 
